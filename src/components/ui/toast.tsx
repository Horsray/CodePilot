    ...
    >
      <div className="flex items-start justify-between w-full gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <span className="text-[14px] font-medium text-foreground/90 break-words" title={toast.message}>
            {toast.message}
          </span>
        </div>
      ...
      {(toast.source || toast.description || toast.action) && (
        <div className="flex items-end justify-between w-full mt-1 min-h-[28px]">
          <div
            className="text-[13px] text-muted-foreground/70 break-words pr-4 pb-0.5"

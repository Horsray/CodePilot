...
const zh: Record<TranslationKey, string> = {
  ...
  'git.connectProvider': '连接到 Git 服务商',
  'git.setupRepo': '设置仓库',
  'git.chooseProvider': '选择你的 Git 服务商开始',
  'git.enterToken': '输入你的个人访问令牌',
  'git.cloneOrInit': '克隆现有仓库或创建新仓库',
  'git.username': '用户名',
  'git.usernamePlaceholder': '输入你的 Git 用户名',
  'git.token': '个人访问令牌',
  'git.tokenPlaceholder': 'ghp_xxxxxxxxxxxx',
  'git.createTokenHint': '创建令牌请访问',
  'git.repoUrl': '仓库地址',
  ...
  'git.enterRepoUrlError': '请输入仓库地址',
  'git.provider.github': 'GitHub',
  'git.provider.gitlab': 'GitLab',
  'git.provider.other': '其他',
  'git.chooseAuthMethod': '选择认证方式并连接到你的 Git 服务商',
  'git.personalAccessToken': '个人访问令牌',
  'git.https': 'HTTPS 密码',
  'git.password': '密码',
  'git.passwordPlaceholder': '输入你的密码或 Token',
  'git.httpsNote': '使用 HTTPS 方式，密码可以是你的 Access Token',
  'git.verifying': '验证中...',
  'git.tokenVerified': 'Token 验证成功',
  'git.tokenInvalid': 'Token 无效，请检查',
  'git.verifyFailed': '验证失败',
  'git.selectRepo': '选择仓库',
  'git.chooseRepoOrCreate': '选择已有仓库或创建新仓库',
  ...
  'git.remoteUrl': '远程仓库地址',
  'git.remoteUrlPlaceholder': 'https://github.com/username/repo.git',
  'git.linkRemote': '关联远程仓库',
  'git.linking': '关联中...',
  'git.linkSuccess': '远程仓库关联成功',
  'git.linkFailed': '关联失败',
  'git.initAndPush': '初始化并推送到远程',
  'git.createRepoFirst': '请先创建远程仓库',
  ...
  'git.notARepoDesc': '当前工作目录不是 Git 仓库。配置 Git 以开始使用版本控制。',
  ...
  // AI Review
  'git.aiReview': 'AI 代码审查',
  'git.aiSummary': 'AI 生成提交信息',
  'git.aiGenerating': '生成中...',
  'git.aiReviewResult': '审查结果',
  'git.aiNoChanges': '需要先有代码更改才能使用 AI 功能',
  'git.aiError': 'AI 分析失败',
  'git.aiCopied': '已复制',
  'git.aiCopy': '复制',
  'git.aiUseMessage': '用作提交信息',
  ...
  'console.searchPlaceholder': '搜索日志（Ctrl/Cmd+K）',
  'console.searchClear': '清空搜索（Esc）',
  'console.noMatch': '未找到匹配日志。',
  'console.matchOnly': '仅匹配',
  'console.showAll': '全部日志',
  'console.toggleMatchesShortcut': '切换仅显示匹配项（Alt+M）',
  'console.select': '选择日志',
  'console.copy': '复制',
  'console.copySelected': '复制 {count} 条',
  'console.copySelectedShortcut': '复制选中日志（Ctrl/Cmd+C）',
  'console.copySingleSuccess': '日志已复制',
  'console.copyBatchSuccess': '已复制 {count} 条日志',
  'console.copyFailed': '复制失败，当前环境不支持剪贴板。',

...
const zh: Record<TranslationKey, string> = {
  ...
  'messageInput.teamDesc': '启用多agent模式，并行执行',
  ...
  'rules.personalDesc': '创建及管理用户自定义规则，这些规则将对所有对话全局生效。',
  'rules.project': '项目规则',
  'rules.projectDesc': '创建专用以此项目的规则。',
  'rules.create': '创建',
  'rules.edit': '编辑',
  'rules.delete': '删除',
  'rules.name': '规则名称',
  'rules.content': '规则内容 (Markdown)',
  'rules.type': '规则类型',
  'rules.enabled': '已启用',
  'rules.targetProjects': '生效项目',
  'rules.allProjects': '所有项目',
  'rules.noRules': '暂无规则',
  'rules.save': '保存',
  'rules.cancel': '取消',
  ...
  'rules.baseRulesDesc': '配置是否自动读取项目内的 AGENTS.md, CLAUDE.md 和技能。',
  ...
  'knowledgeBase.title': '原子知识库',
  'knowledgeBase.description': '基于 graphify 构建的结构化知识系统。',
  'knowledgeBase.import': '导入知识',
  'knowledgeBase.importPlaceholder': '输入文件路径或 URL...',
  'knowledgeBase.learn': '学习',
  'knowledgeBase.learning': '学习中...',
  'knowledgeBase.graphTitle': '知识图谱',
  'knowledgeBase.reportTitle': '知识报告',
  'knowledgeBase.noGraph': '尚未构建知识图谱',
  'knowledgeBase.searchPlaceholder': '搜索知识节点...',
  'knowledgeBase.categories': '知识分类',
  'knowledgeBase.allTypes': '所有类型',
  'assistant.docsRefreshed': '目录文档已刷新',
  'assistant.settings.includeAgentsMd': '将 AGENTS.md 包含在上下文中',
  'assistant.settings.includeAgentsMdDesc': '智能体将读取根目录中的 AGENTS.md 文件并将其添加到上下文中。',
  'assistant.settings.includeClaudeMd': '将 CLAUDE.md 包含在上下文中',
  'assistant.settings.includeClaudeMdDesc': '智能体将读取根目录中的 CLAUDE.md 和 CLAUDE.local.md 文件并将其添加到上下文中。',
  'assistant.settings.enableAgentsSkills': '启用 .agents 技能目录',
  'assistant.settings.enableAgentsSkillsDesc': '开启后，智能体将自动加载 .agents/skills 路径下的自定义技能。',
  'assistant.settings.syncProjectRules': '从项目同步规则',
  'assistant.settings.syncProjectRulesDesc': '开启后，智能体将自动加载项目内 .trae/rules/rules.md 的规则。',
  'assistant.settings.knowledgeBaseEnabled': '启用原子知识库',
  'assistant.settings.knowledgeBaseEnabledDesc': '开启后，智能体将优先从知识库中检索信息并遵循其中的图谱结构。',
  ...
  'settings.assistantContext': '助手上下文规则 (全局)',
  'settings.email': '邮箱',
  ...
  'git.discardFile': '丢弃',
  'git.discardAll': '丢弃全部',
  'git.discardConfirm': '确定要丢弃吗？此操作无法撤销。',
  'git.viewDiff': '查看差异',
  ...
  'git.pushToOtherBranch': '推送到指定分支',
  'git.pushToNewBranch': '创建并推送到新分支',
  'git.targetBranch': '目标分支',
  ...
  'git.stashPop': '弹出',
  'git.stashDrop': '删除',
  'git.stashSuccess': '更改已储藏',
  'git.stashPopSuccess': '储藏已应用',
  'git.stashDropSuccess': '储藏已删除',
  'git.stashFailed': '储藏操作失败',
  'git.stashSaving': '储藏中...',

  // AI Review
  'git.aiSummary': 'AI 提交信息',
  'git.aiReview': 'AI 评审',
  'git.aiReviewResult': '评审结果',
  'git.aiGenerating': '生成中...',
  'git.aiError': 'AI 评审失败',
  'git.aiNoChanges': '没有可评审的更改',
  ...
  // Config
  'git.configTitle': '配置 Git',
  'git.configureGit': '配置 Git',
  'git.connectProvider': '连接 Git 提供商',
  'git.connectGitHub': '连接到 GitHub',
  'git.setupRepo': '设置仓库',
  'git.chooseProvider': '选择您的 Git 提供商以开始',
  'git.chooseAuthMethod': '选择认证方式并连接到您的 Git 提供商',
  'git.chooseRepoOrCreate': '选择现有仓库或创建新仓库',
  'git.enterToken': '输入您的个人访问令牌',
  'git.enterTokenError': '请输入令牌',
  'git.tokenInvalid': '令牌无效，请检查',
  'git.verifyFailed': '验证失败',
  'git.verifying': '验证中...',
  'git.tokenVerified': '令牌验证成功',
  'git.cloneOrInit': '克隆现有仓库或创建新仓库',
  'git.clone': '克隆',
  'git.cloning': '克隆中...',
  ...
  'git.initSuccess': 'Git 仓库已初始化',
  'git.initAndPush': '初始化并推送到远程',
  'git.or': '或者',
  'git.back': '返回',
  'git.continue': '继续',
  'git.saving': '保存中...',
  'git.configSaved': 'Git 配置已保存',
  'git.saveFailed': '保存失败',
  'git.enterRepoUrlError': '请输入仓库 URL',
  'git.linkRemote': '链接远程仓库',
  'git.linkSuccess': '远程仓库链接成功',
  'git.linkFailed': '链接远程失败',
  'git.linking': '链接中...',
  'git.selectRepo': '选择仓库',
  'git.foundRepos': '找到 {count} 个仓库',
  'git.createNewRepo': '创建新仓库',
  'git.configureProject': '配置项目：{path}',
  'git.projectPath': '项目路径',
  'git.projectPathPlaceholder': '选择项目路径',
  'git.currentProject': '当前项目路径',
  'git.enterProjectPathError': '请选择项目路径',
  'git.remoteUrl': '远程仓库 URL',
  'git.remoteUrlPlaceholder': 'https://github.com/username/repo.git',
  'git.selectFolder': '选择文件夹',
  'git.selectFolderFailed': '选择文件夹失败',
  'git.enterCredentialsError': '请输入用户名和密码',
  'git.credentialsSaved': '凭据已保存',
  'git.createRepoFirst': '请先创建一个远程仓库',
  'git.fetchReposFailed': '获取仓库列表失败',
  'git.noReposFound': '未找到仓库',
  'git.provider.github': 'GitHub',
  'git.provider.gitlab': 'GitLab',
  'git.provider.other': '其他',
  'git.repoUrl': '仓库 URL',
  'git.repoUrlPlaceholder': 'https://github.com/username/repo.git',
  'git.username': '用户名',
  'git.usernamePlaceholder': '输入您的 Git 用户名',
  'git.token': '个人访问令牌',
  'git.tokenPlaceholder': 'ghp_xxxxxxxxxxxx',
  'git.createTokenHint': '在以下位置创建令牌',
  'git.https': 'HTTPS 密码',
  'git.httpsNote': '使用 HTTPS，密码可以是您的访问令牌',
  'git.password': '密码',
  'git.passwordPlaceholder': '输入您的密码或令牌',
  'git.notARepoDesc': '此工作区不是 Git 仓库。配置 Git 以开始版本控制。',

  // ── Terminal ──────────────────────────────────────────────────
  'terminal.title': '终端',
  'terminal.close': '关闭终端',
  'terminal.open': '打开终端',
  'terminal.sendToChat': '发送选中内容到聊天',
  'terminal.sendLineToChat': '添加到对话',
  'terminal.sendSelectionToChat': '添加选区到对话',
  'terminal.sendAllToChat': '添加全部输出到对话',
  'terminal.resetHeight': '重置高度',
  ...
  'terminal.failedToConnect': '连接终端失败',
  'terminal.terminalErrorTitle': '终端错误',
  'terminal.terminalErrorHint': '请检查终端配置或重启应用。',
  'terminal.retry': '重试',
  'browser.urlPlaceholder': '输入 URL（例如 https://example.com）',
  'browser.preview': '预览',
  'browser.empty': '暂无页面',
  'browser.emptyHint': '在上方输入 URL 并按回车加载。',
  'console.all': '全部',
  'console.searchPlaceholder': '搜索日志（空格表示且）',
  'console.searchClear': '清除搜索',
  'console.toggleMatchesShortcut': '切换仅匹配视图（M）',
  'console.matchOnly': '仅匹配',
  'console.showAll': '显示全部',
  'console.copySelectedShortcut': '复制选中行（⌘/Ctrl+C）',
  'console.copySelected': '复制选中（{count}）',
  'console.clear': '清空',
  'console.noMatch': '没有匹配日志',
  'console.empty': '暂无日志',
  'console.select': '选择',
  'console.copy': '复制',
  'console.copySingleSuccess': '已复制 1 行',
  'console.copyBatchSuccess': '已复制 {count} 行',
  'console.copyFailed': '复制日志失败',
  'bottomPanel.terminal': '终端',
  'bottomPanel.console': '控制台',
  'bottomPanel.close': '关闭',

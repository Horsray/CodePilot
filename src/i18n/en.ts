...
const en = {
  ...
  'git.personalAccessToken': 'Personal Access Token',
  ...
  'git.chooseRepoOrCreate': 'Choose an existing repository or create a new one',
  ...
  'console.searchPlaceholder': 'Search logs (Ctrl/Cmd+K)',
  'console.searchClear': 'Clear search (Esc)',
  'console.noMatch': 'No matching logs.',
  'console.matchOnly': 'Matches',
  'console.showAll': 'All logs',
  'console.toggleMatchesShortcut': 'Toggle matches only (Alt+M)',
  'console.select': 'Select log',
  'console.copy': 'Copy',
  'console.copySelected': 'Copy {count}',
  'console.copySelectedShortcut': 'Copy selected logs (Ctrl/Cmd+C)',
  'console.copySingleSuccess': 'Log copied',
  'console.copyBatchSuccess': 'Copied {count} logs',
  'console.copyFailed': 'Copy failed. Clipboard is unavailable.',

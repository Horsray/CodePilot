...
const en = {
  ...
  'messageInput.teamDesc': 'Enable multi-agent team mode for parallel execution',
  ...
  'rules.syncedReadOnly': 'Synced rules are read-only',
  ...
  'knowledgeBase.title': 'Atomic Knowledge Base',
  'knowledgeBase.description': 'Structured knowledge system built on graphify.',
  'knowledgeBase.import': 'Import Knowledge',
  'knowledgeBase.importPlaceholder': 'Enter file path or URL...',
  'knowledgeBase.learn': 'Learn',
  'knowledgeBase.learning': 'Learning...',
  'knowledgeBase.graphTitle': 'Knowledge Graph',
  'knowledgeBase.reportTitle': 'Knowledge Report',
  'knowledgeBase.noGraph': 'No knowledge graph built yet',
  'knowledgeBase.searchPlaceholder': 'Search knowledge nodes...',
  'knowledgeBase.categories': 'Knowledge Categories',
  'knowledgeBase.allTypes': 'All Types',
  ...
  'scheduledTasks.description': '管理系统定时任务，监控执行状态和历史日志。',
  'scheduledTasks.addTask': '新建任务',
  'scheduledTasks.createTask': '创建定时任务',
  'scheduledTasks.taskName': '任务名称',
  'scheduledTasks.taskNamePlaceholder': '例如：每日股票行情查询',
  'scheduledTasks.prompt': '执行内容',
  'scheduledTasks.promptPlaceholder': '输入 AI 需要执行的任务描述...',
  'scheduledTasks.scheduleType': '执行方式',
  'scheduledTasks.scheduleOnce': '一次性',
  'scheduledTasks.scheduleInterval': '间隔重复',
  'scheduledTasks.scheduleCron': 'Cron 表达式',
  'scheduledTasks.scheduleValue': '时间设置',
  'scheduledTasks.intervalPlaceholder': '例如：30m, 2h, 1d',
  'scheduledTasks.cronPlaceholder': '例如：0 9 * * *（每天9点）',
  'scheduledTasks.oncePlaceholder': '选择一个日期时间',
  'scheduledTasks.priority': '优先级',
  'scheduledTasks.priorityLow': '低',
  'scheduledTasks.priorityNormal': '普通',
  'scheduledTasks.priorityUrgent': '紧急',
  'scheduledTasks.notifyOnComplete': '执行完成后通知',
  'scheduledTasks.workingDirectory': '工作目录（可选）',
  'scheduledTasks.active': '执行中',
  'scheduledTasks.paused': '已暂停',
  'scheduledTasks.completed': '已完成',
  'scheduledTasks.disabled': '已禁用',
  'scheduledTasks.running': '执行中',
  'scheduledTasks.success': '成功',
  'scheduledTasks.error': '失败',
  ...
  'scheduledTasks.lastResult': '上次结果',
  'scheduledTasks.lastError': '错误信息',
  'scheduledTasks.consecutiveErrors': '连续失败',
  'scheduledTasks.executionLogs': '执行日志',
  'scheduledTasks.noLogs': '暂无执行记录',
  'scheduledTasks.logSuccess': '成功',
  'scheduledTasks.logFailed': '失败',
  'scheduledTasks.duration': '耗时',
  'scheduledTasks.noTasks': '暂无定时任务',
  'scheduledTasks.noTasksHint': '点击右上角「新建任务」或让智能体帮你创建。',
  'scheduledTasks.confirmDelete': '确定要删除此定时任务吗？',
  'scheduledTasks.cancel': '取消',
  'scheduledTasks.create': '创建',
  'scheduledTasks.update': '更新',
  'scheduledTasks.filterAll': '全部',
  'scheduledTasks.filterActive': '执行中',
  'scheduledTasks.filterPaused': '已暂停',
  ...
  'git.pushToCurrentBranch': 'Push to current branch',
  'git.pushToOtherBranch': 'Push to specific branch',
  'git.pushToNewBranch': 'Create & push to new branch',
  ...
  // Config
  'git.configTitle': 'Configure Git',
  'git.configureGit': 'Configure Git',
  'git.connectProvider': 'Connect to Git Provider',
  'git.connectGitHub': 'Connect to GitHub',
  'git.setupRepo': 'Setup Repository',
  'git.chooseProvider': 'Choose your Git provider to get started',
  'git.chooseAuthMethod': 'Choose authentication method and connect to your Git provider',
  'git.chooseRepoOrCreate': 'Choose an existing repository or create a new repository',
  'git.enterToken': 'Enter your personal access token',
  'git.enterTokenError': 'Please enter a token',
  'git.tokenInvalid': 'Invalid token, please check',
  'git.verifyFailed': 'Verification failed',
  'git.verifying': 'Verifying...',
  'git.tokenVerified': 'Token verified successfully',
  'git.cloneOrInit': 'Clone an existing repository or create a new one',
  'git.clone': 'Clone',
  'git.cloning': 'Cloning...',
  'git.cloneFailed': 'Clone failed',
  'git.cloneSuccess': 'Repository cloned successfully',
  'git.initRepo': 'Initialize New Repository',
  'git.initFailed': 'Failed to initialize repository',
  'git.initSuccess': 'Git repository initialized',
  'git.initAndPush': 'Initialize and Push to Remote',
  'git.or': 'Or',
  'git.back': 'Back',
  'git.continue': 'Continue',
  'git.saving': 'Saving...',
  'git.configSaved': 'Git configuration saved',
  'git.saveFailed': 'Save failed',
  'git.enterRepoUrlError': 'Please enter a repository URL',
  'git.linkRemote': 'Link Remote Repository',
  'git.linkSuccess': 'Remote repository linked successfully',
  'git.linkFailed': 'Failed to link remote',
  'git.linking': 'Linking...',
  'git.selectRepo': 'Select Repository',
  'git.foundRepos': 'Found {count} repositories',
  'git.createNewRepo': 'Create New Repository',
  'git.configureProject': 'Configure project: {path}',
  'git.projectPath': 'Project Path',
  'git.projectPathPlaceholder': 'Select project path',
  'git.currentProject': 'Current project path',
  'git.enterProjectPathError': 'Please select a project path',
  'git.remoteUrl': 'Remote Repository URL',
  'git.remoteUrlPlaceholder': 'https://github.com/username/repo.git',
  'git.selectFolder': 'Select Folder',
  'git.selectFolderFailed': 'Failed to select folder',
  'git.enterCredentialsError': 'Please enter username and password',
  'git.credentialsSaved': 'Credentials saved',
  'git.createRepoFirst': 'Please create a remote repository first',
  'git.fetchReposFailed': 'Failed to fetch repository list',
  'git.noReposFound': 'No repositories found',
  'git.provider.github': 'GitHub',
  'git.provider.gitlab': 'GitLab',
  'git.provider.other': 'Other',
  'git.repoUrl': 'Repository URL',
  'git.repoUrlPlaceholder': 'https://github.com/username/repo.git',
  'git.username': 'Username',
  'git.usernamePlaceholder': 'Enter your Git username',
  'git.token': 'Personal Access Token',
  'git.tokenPlaceholder': 'ghp_xxxxxxxxxxxx',
  'git.createTokenHint': 'Create a token at',
  'git.https': 'HTTPS Password',
  'git.httpsNote': 'Using HTTPS, password can be your Access Token',
  'git.password': 'Password',
  'git.passwordPlaceholder': 'Enter your password or token',
  'git.notARepoDesc': 'This workspace is not a Git repository. Configure Git to get started with version control.',

  // ── Terminal ──────────────────────────────────────────────────
  'terminal.title': 'Terminal',
  'terminal.close': 'Close terminal',
  'terminal.open': 'Open terminal',
  'terminal.sendToChat': 'Send selection to chat',
  'terminal.sendLineToChat': 'Add to chat',
  'terminal.sendSelectionToChat': 'Add selection to chat',
  'terminal.sendAllToChat': 'Add all output to chat',
  'terminal.resetHeight': 'Reset height',
  ...
  'terminal.failedToConnect': 'Failed to connect to terminal',
  'terminal.terminalErrorTitle': 'Terminal Error',
  'terminal.terminalErrorHint': 'Please check your terminal configuration or restart the app.',
  'terminal.retry': 'Retry',
  'browser.urlPlaceholder': 'Enter URL (e.g. https://example.com)',
  'browser.preview': 'Preview',
  'browser.empty': 'No page loaded',
  'browser.emptyHint': 'Enter a URL above and press Enter to load.',
  'console.all': 'All',
  'console.searchPlaceholder': 'Search logs (space = AND)',
  'console.searchClear': 'Clear search',
  'console.toggleMatchesShortcut': 'Toggle match-only view (M)',
  'console.matchOnly': 'Match only',
  'console.showAll': 'Show all',
  'console.copySelectedShortcut': 'Copy selected rows (⌘/Ctrl+C)',
  'console.copySelected': 'Copy Selected ({count})',
  'console.clear': 'Clear',
  'console.noMatch': 'No matching logs',
  'console.empty': 'No logs yet',
  'console.select': 'Select',
  'console.copy': 'Copy',
  'console.copySingleSuccess': 'Copied 1 row',
  'console.copyBatchSuccess': 'Copied {count} rows',
  'console.copyFailed': 'Failed to copy logs',
  'bottomPanel.terminal': 'Terminal',
  'bottomPanel.console': 'Console',
  'bottomPanel.close': 'Close',

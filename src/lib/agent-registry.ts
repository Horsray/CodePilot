...
const BUILTIN_AGENTS: AgentDefinition[] = [
  ...
  },
  {
    ...
    mode: 'subagent',
    allowedTools: ['Read', 'Glob', 'Grep', 'SearchCodebase', 'mcp__filesystem__read_file', 'mcp__filesystem__read_text_file', 'mcp__filesystem__search_files', 'mcp__filesystem__list_directory'],
    maxSteps: 25,
  ...
  },
  {
    ...
    mode: 'subagent',
    allowedTools: ['Read', 'Glob', 'Grep', 'codepilot_kb_search', 'mcp__filesystem__read_file', 'mcp__filesystem__read_text_file', 'mcp__filesystem__search_files', 'mcp__filesystem__list_directory'],
    maxSteps: 30,
